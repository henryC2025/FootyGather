...
describe('GameAddCommentDialogComponent', () =>
{
    ...
    beforeEach(async () =>
    {
        ...
        webServiceMock =
        {
            addGameComment: jasmine.createSpy('addGameComment').and.returnValue(of({})),
        }

        sharedServiceMock =
        {
            showNotification: jasmine.createSpy(),
            game_comments_updated: { next: jasmine.createSpy('next') }
        };
    ...
    it('should not submit a comment if the form is invalid', () =>
    {
        ...
        expect(webServiceMock.addGameComment).not.toHaveBeenCalled();
    });
    ...
    it('should submit a comment if the form is valid and user is authenticated', () =>
    {
        ...
        expect(webServiceMock.addGameComment).toHaveBeenCalled();
    });
});
